    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-between  '>
                ...
                <p className='font-normal text-[20px] text-[#5D5567] leading-[30px] mb-[40px]'>Chez Falcon Express, nous offrons des options de tarification adaptées pour un service de qualité à un prix accessible.</p>
                <div className="mb-10">
